  ...
  return (
    <Animated.View style={[styles.container, containerAnimated]}>
      ...
      <Text style={styles.textInfo}>
        {data.amount} <Text style={styles.strong}>{data.title}</Text> topping{" "}
        <Text style={styles.strong}>{data.size}</Text> 
      </Text>
      <TouchableOpacity
        activeOpacity={0.7}
      ...
      >
        <Text style={[styles.strong, styles.textAction]}>THANH TOÁN</Text>
